...
The hackathon runtime uses a dedicated Alpaca PAPER competition account with an initial $100,000 balance. API credentials are injected server-side and are never committed to GitHub.
...
- Competition account initial $100,000 verification: **PENDING LIVE PROBE**
